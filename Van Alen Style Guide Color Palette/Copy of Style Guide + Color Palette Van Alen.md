### **Van Alen Institute – Web App Style Guide (Revised)**
**Version 2.0 — Based on Website Audit & Asset Analysis**
####**1. Core Design Philosophy**
Align with the public mission: **Clean, bold, modern, and community-centered.** Prioritize clarity, purposeful storytelling, and accessible, inclusive design. The aesthetic is institutional and trustworthy, not overly decorative or corporate.
...
---
### **Summary of Critical Revisions for Your App:**
1.  **Color Palette:** Replace the conceptual "Civic Teal" with the actual **Warm Orange (`#FF710F`)** as the primary accent. Integrate the observed blues (`#DEECFF`, `#EEEFFF`) for filters and the green (`#27AE60`) for specific actions.
2.  **UI Patterns:** Model filter/tag states **( )** vs **[ ]** and button styles directly from the website screenshots.
3.  **Typography & Space:** Emulate the clean, bold, and spacious text hierarchy shown.
4.  **Visual Language:** Use human-centered, photographic imagery as the primary visual element.
This revised guide should ensure your web app aligns visually and functionally with the Van Alen Institute's digital presence.
________________


Van Alen Institute's Sponsor Notes on their style choices:
I. Core Philosophy: Community-Centered & Purposeful Design
* Design as a Tool for Change: UI/UX should serve to solve problems, push communities forward, and drive action.
* Intentionality: Every design choice should be deliberate, aiming to achieve a specific goal rather than being arbitrary.
* Accessibility & Inclusivity: Design should make information understandable and accessible to diverse audiences, promoting a sense of belonging for everyone.
* Storytelling: The UI should help tell the organization's story and the work they do in an empowering and bold way.